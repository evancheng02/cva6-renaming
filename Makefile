...
# EE 282 students: uncomment the line below and replace PATH_TO_DHRYSTONE
# with the path to the dhrystone.riscv file in your cva6 directory on caddy
# For example, depending on where you cloned the cva6 directory, the path 
# may be /home/sunetid/cva6/dhrystone.riscv 

#elf-bin        ?= PATH_TO_DHRYSTONE
...
XRUN_INCDIR :=+incdir+$(CVA6_HOME)/src/axi_node 	\
	...
	+incdir+$(CVA6_HOME)/corev_apu/tb/common \
	+incdir+$(CVA6_HOME)/corev_apu/register_interface/include \
	+incdir+$(CVA6_HOME)/common/submodules/common_cells/include 	\
	+incdir+$(CVA6_HOME)/vendor/pulp-platform/common_cells/src \
	+incdir+$(CVA6_HOME)/core/include \
	-y $(CVA6_HOME)/core/include \
...
XRUN_RUN_FLAGS := -R -gui -64bit -disable_sem2009 -access +rwc -timescale 1ns/1ps		\
...
XRUN_COMP = $(XRUN_COMP_FLAGS)		\
	...
	$(XRUN_INCDIR)		      	\
	$(filter %.svh, $(CVA6_HOME)/corev_apu/tb/common) \
	$(filter %.svh, $(CVA6_HOME)/vendor/pulp-platform/axi/include/axi) \
	$(filter %.svh, $(CVA6_HOME)/vendor/pulp-platform/axi/src) \
	$(filter %.sv, $(CVA6_HOME)/vendor/pulp-platform/axi/src) \
	$(CVA6_HOME)/vendor/pulp-platform/common_cells/src/cf_math_pkg.sv \
	$(filter %.sv, $(CVA6_HOME)/vendor/pulp-platform/common_cells/src) \
	$(CVA6_HOME)/vendor/pulp-platform/axi/src/axi_pkg.sv \
	$(CVA6_HOME)/core/include/cv64a6_imafdc_sv39_config_pkg.sv \
	$(CVA6_HOME)/core/include/ariane_dm_pkg.sv \
	$(CVA6_HOME)/core/include/riscv_pkg.sv \
	$(CVA6_HOME)/core/include/ariane_pkg.sv \
	$(CVA6_HOME)/core/include/ariane_rvfi_pkg.sv \
	$(CVA6_HOME)/core/include/ariane_axi_pkg.sv \
	$(CVA6_HOME)/core/my_module.sv \
    $(CVA6_HOME)/core/renaming_map.sv \
